...
class Path extends CActiveRecord 
{
    ...
    {
        return Yii::app()->db->tablePrefix.'path';
    }
    ...
    public function relations()
    {
        ...
        return array(
            'technology' => array(self::MANY_MANY, 'Technology', 'gns_path_technology(id_path, id_technology)'),
        );
    }
    ...
    */
    ...
    {
        /* zero array technology */
        if (!isset($_POST[__CLASS__]['technology']) || count($_POST[__CLASS__]['technology']) == 0)
